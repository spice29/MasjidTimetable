...
- (void)viewDidLoad {
    ...
    if ([addpri count]==1) {
        ...
        UIAlertView * errorAlert = [[UIAlertView alloc] initWithTitle:@"Message" message:@"Please set priority of your favorite masjid to see its Time Table" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [errorAlert show];
    }
...
-(void)swipeleft:(UISwipeGestureRecognizer*)gestureRecognizer
{
    ...
    if (month>12) {
        ...
        UIAlertView * errorAlert = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"No more data available" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [errorAlert show];
    }
    else if (month==12) {
        self.landscapePage.currentPage=get+1;
...
-(void)swiperight:(UISwipeGestureRecognizer*)gestureRecognizer
{
    ...
    {
        self.landscapePage.currentPage=0;
        UIAlertView * errorAlert = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"No data available for previous month" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [errorAlert show];
    ...
    AFJSONRequestOperation *operation = [AFJSONRequestOperation JSONRequestOperationWithRequest:request
                                                                                        success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
                                                                                            ...
                                                                                            if ([jsonObject count]==0) {
                                                                                                UIAlertView * errorAlert = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"No Data to show" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
                                                                                                [errorAlert show];
                                                                                            ...
                                                                                            else
                                                                                            {
                                                                                                ...
                                                                                                else if (month>12)
                                                                                                {
                                                                                                    ...
                                                                                                    [self.timeTable reloadData];
                                                                                                    UIAlertView * errorAlert = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"No Data for this month" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
                                                                                                    [errorAlert show];
                                                                                                }
                                                                                                else
                                                                                                {

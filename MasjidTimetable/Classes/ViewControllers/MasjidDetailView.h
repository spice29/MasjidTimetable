...
@interface MasjidDetailView : UIViewController <UITableViewDataSource,UITableViewDelegate,UIGestureRecognizerDelegate>
...
@property (weak, nonatomic) IBOutlet UIButton *naveRight;
...
@property (weak, nonatomic) IBOutlet UILabel *quat;
@property (weak, nonatomic) IBOutlet UILabel *pleaseSelect;
